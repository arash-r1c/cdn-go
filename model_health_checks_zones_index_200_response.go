...
// checks if the HealthChecksZonesIndex200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HealthChecksZonesIndex200Response{}
...
func NewHealthChecksZonesIndex200Response() *HealthChecksZonesIndex200Response {
	this := HealthChecksZonesIndex200Response{}
	return &this
}
...
type NullableHealthChecksZonesIndex200Response struct {
	value *HealthChecksZonesIndex200Response
	isSet bool
}

func (v NullableHealthChecksZonesIndex200Response) Get() *HealthChecksZonesIndex200Response {
	return v.value
}

func (v *NullableHealthChecksZonesIndex200Response) Set(val *HealthChecksZonesIndex200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableHealthChecksZonesIndex200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableHealthChecksZonesIndex200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHealthChecksZonesIndex200Response(val *HealthChecksZonesIndex200Response) *NullableHealthChecksZonesIndex200Response {
	return &NullableHealthChecksZonesIndex200Response{value: val, isSet: true}
}

func (v NullableHealthChecksZonesIndex200Response) MarshalJSON() ([]byte, error) {

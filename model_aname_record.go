...
// checks if the ANAMERecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ANAMERecord{}
...
func (v NullableANAMERecord) Get() *ANAMERecord {
	return v.value
}
...
func NewNullableANAMERecord(val *ANAMERecord) *NullableANAMERecord {
	return &NullableANAMERecord{value: val, isSet: true}
}

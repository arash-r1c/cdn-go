...
func (r ApiRedirectShowRequest) Execute() (*RedirectData, *http.Response, error) {
	return r.ApiService.RedirectShowExecute(r)
}
...
func (a *RedirectApiService) RedirectShowExecute(r ApiRedirectShowRequest) (*RedirectData, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *RedirectData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RedirectApiService.RedirectShow")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/domains/{domain}/settings/www-redirect"
...
func (r ApiRedirectUpdateRequest) Redirect(redirect Redirect) ApiRedirectUpdateRequest {
	r.redirect = &redirect
	return r
}

func (r ApiRedirectUpdateRequest) Execute() (*MessageResponse, *http.Response, error) {
	return r.ApiService.RedirectUpdateExecute(r)
}
...
func (a *RedirectApiService) RedirectUpdateExecute(r ApiRedirectUpdateRequest) (*MessageResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RedirectApiService.RedirectUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

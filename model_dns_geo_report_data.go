...
// checks if the DnsGeoReportData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsGeoReportData{}
...
type NullableDnsGeoReportData struct {
	value *DnsGeoReportData
	isSet bool
}

func (v NullableDnsGeoReportData) Get() *DnsGeoReportData {
	return v.value
}

func (v *NullableDnsGeoReportData) Set(val *DnsGeoReportData) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDnsGeoReportData(val *DnsGeoReportData) *NullableDnsGeoReportData {
	return &NullableDnsGeoReportData{value: val, isSet: true}
}

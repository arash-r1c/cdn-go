...
// checks if the VisitorsChartsVisitorsSeriesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VisitorsChartsVisitorsSeriesInner{}
...
func NewVisitorsChartsVisitorsSeriesInner() *VisitorsChartsVisitorsSeriesInner {
	this := VisitorsChartsVisitorsSeriesInner{}
	return &this
}
...
type NullableVisitorsChartsVisitorsSeriesInner struct {
	value *VisitorsChartsVisitorsSeriesInner
	isSet bool
}

func (v NullableVisitorsChartsVisitorsSeriesInner) Get() *VisitorsChartsVisitorsSeriesInner {
	return v.value
}

func (v *NullableVisitorsChartsVisitorsSeriesInner) Set(val *VisitorsChartsVisitorsSeriesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableVisitorsChartsVisitorsSeriesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableVisitorsChartsVisitorsSeriesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVisitorsChartsVisitorsSeriesInner(val *VisitorsChartsVisitorsSeriesInner) *NullableVisitorsChartsVisitorsSeriesInner {
	return &NullableVisitorsChartsVisitorsSeriesInner{value: val, isSet: true}
}

func (v NullableVisitorsChartsVisitorsSeriesInner) MarshalJSON() ([]byte, error) {

...
*LoadBalancingApi* | [**LoadBalancersPoolsUpdatePool**](LoadBalancingApi.md#loadbalancerspoolsupdatepool) | **Patch** /domains/{domain}/load-balancers/{loadBalancerId}/pools/{loadBalancerPoolId} | Update an existing load balancer pool without origins
